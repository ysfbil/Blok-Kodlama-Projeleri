(function () {
    var documentClassGazBasinci;

    function GazBasinci() {
        var player = new VFabrikaPlayer(vFabrikaPlayerData_GazBasinci);
    ...
    $(framework).on(Framework.ONREADY, function () {
        documentClassGazBasinci = new GazBasinci();
        documentClassGazBasinci.initialize();
    });
})();
