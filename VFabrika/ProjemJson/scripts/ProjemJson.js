(function () {
    var documentClassProjemJson;

    function ProjemJson() {
        var player = new VFabrikaPlayer(vFabrikaPlayerData_ProjemJson);
    ...
    $(framework).on(Framework.ONREADY, function () {
        documentClassProjemJson = new ProjemJson();
        documentClassProjemJson.initialize();
    });
})();
