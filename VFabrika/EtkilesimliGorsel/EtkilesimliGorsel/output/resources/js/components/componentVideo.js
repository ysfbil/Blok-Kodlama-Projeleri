function ComponentVideo() {
    ...
    this.initialize = function() {
        ...
        self.$component = $("#component-video");
    ...
    this.show = function(data, options) {
        ...
        self.$video = self.$component.find("video").first();
        self.$video.attr("src", framework.localPath + "video/" + data.video);
        self.$video[0].load();
        self.$video[0].play();
