(function () {
    var documentClassSurukle_Birak;

    function Surukle_Birak() {
        var player = new VFabrikaPlayer(vFabrikaPlayerData_Surukle_Birak);
    ...
    $(framework).on(Framework.ONREADY, function () {
        documentClassSurukle_Birak = new Surukle_Birak();
        documentClassSurukle_Birak.initialize();
    });
})();
